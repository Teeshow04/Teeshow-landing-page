...
const RevieCard = ({ image, name, profession, text }: Props) => {
  return (
    <div className="w-full lg:w-[90%] relative mx-auto p-6 bg-white shadow-lg rounded-lg">
      ...
      <div className="grid grid-cols-1 lg:grid-cols gap-6 items-center">
        <div className="col-span-3 order-2 lg:order-1 ">
          <p className="mt-8 text-sm sm:text-base md:text-lg font-medium leading-[1.5rem] sm:leading-[1.8rem] md:leading-2[2.5rem]">
            {text}
          </p>
