        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 items-center gap-12">
          ...
          <div>
            ...
            <p className="text-gray-700">
              Enhance productivity with a seamless, all-in-one workspace.
              Designed to meet your daily professional and creative needs.
              Organize, collaborate, and achieve more effortlessly. Experience
              the ultimate tool for efficiency and success. Let me know if you’d
              like any adjustments!
            </p>

            {/* play store and apple store image */}
